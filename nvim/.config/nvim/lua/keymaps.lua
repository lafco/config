...
-- Telescope LSP symbols with word under cursor as search
map('n', 'gs', function()
  local word = vim.fn.expand('<cword>')
  require('telescope.builtin').lsp_document_symbols({ default_text = word })
end, { desc = 'Document symbols (word)' })
map('n', 'gw', function()
  local word = vim.fn.expand('<cword>')
  require('telescope.builtin').lsp_dynamic_workspace_symbols({ default_text = word })
end, { desc = 'Workspace symbols (word)' })

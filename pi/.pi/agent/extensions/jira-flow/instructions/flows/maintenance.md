...
4. Se a causa estiver comprovada, a entrega é:
   - **uma tarefa de correção** (`Codificação [BACKEND]`/`[FRONTEND]`, ou `Defeito`), cujos critérios de aceite incluem a **validação com a evidência real do relato** (base/empresa/matrícula);
